...
window.VMS_CONFIG = {
  ...
  // Chunk size for video upload to Apps Script.
  // ⚠ Hard limit: Google Apps Script CacheService caps each cached value at
  // 100 KB. Base64 inflates binary by ~33%, so the binary chunk must be
  // ≤ ~75 KB. 70 KB leaves safe headroom.
